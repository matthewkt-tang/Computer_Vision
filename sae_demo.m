...
%save([CIFAR_DIR '/centroids.mat'], 'centroids', 'M', 'P');
load([CIFAR_DIR '/centroids.mat']);
...
if exist([CIFAR_DIR '/fv0.mat'], 'file')
    load([CIFAR_DIR '/fv0.mat']);
else
    filtVecs = randn(numFilters, dataDim);
    save([CIFAR_DIR '/fv0.mat'], 'filtVecs');
end
%}
filtVecs = fvMatrix';
